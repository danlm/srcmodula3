...
<*UNUSED*> CONST
  ...
  UdirImplRCSHeader = "$Header: /mnt1/muller/m3/dev/src/libs/aix-3-1/os/RCS/Udir.m3,v 1.3 1991/03/21 23:05:52 muller Exp $";
  UdirImplDate = "$Date: 1991/03/21 23:05:52 $";
  UdirImplRevision = "$Revision: 1.3 $";
