...
<*UNUSED*> CONST
  ...
  UdirRCSHeader = "$Header: /mnt1/muller/m3/dev/src/libs/aix-3-1/os/RCS/Udir.i3,v 1.3 1991/03/07 00:57:25 muller Exp $";
  UdirDate = "$Date: 1991/03/07 00:57:25 $";
  UdirRevision = "$Revision: 1.3 $";
